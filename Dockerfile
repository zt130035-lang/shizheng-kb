...
RUN mkdir -p /data/news_archive /data/daily_reports /data/knowledge_db /data/pdf_uploads /data/pdf_questions /data/topics /data/morning_cards /data/essay_images
