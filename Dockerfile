...
RUN mkdir -p /data/news_archive /data/daily_reports /data/knowledge_db /data/pdf_uploads /data/pdf_questions /data/topics /data/morning_cards
...
# Start with gunicorn
CMD ["gunicorn", "server:app", "--bind", "0.0.0.0:7860", "--timeout", "120", "--workers", "2"]
